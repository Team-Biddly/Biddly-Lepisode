...
export class BidSyncService implements OnModuleInit {
  ...
  async syncBidConstructions(): Promise<SyncResult> {
    ...
    while (true) {
      ...
      for (const item of response.response.body.items) {
        ...
        const check = await this.prisma.bid_Construction.findUnique({
          where: { id: data.id },
          select: { id: true },
        });
        ...
        await this.prisma.bid_Construction.create({ data });
      }
  ...
  async syncBidThings(): Promise<SyncResult> {
    ...
    while (true) {
      ...
      for (const item of response.response.body.items) {
        ...
        const check = await this.prisma.bid_Thing.findUnique({
          where: { id: data.id },
          select: { id: true },
        });
        ...
        await this.prisma.bid_Thing.create({ data });
      }
  ...
  async sincBidService(): Promise<SyncResult> {
    ...
    while (true) {
      ...
      for (const item of response.response.body.items) {
        ...
        const check = await this.prisma.bid_Service.findUnique({
          where: { id: data.id },
          select: { id: true },
        });
        ...
        await this.prisma.bid_Service.create({ data });
      }
  ...
  async syncBidForeign(index?: Date): Promise<SyncResult> {
    ...
    while (true) {
      ...
      for (const item of response.response.body.items) {
        ...
        const check = await this.prisma.bid_Foreign.findUnique({
          where: { id: data.id },
          select: { id: true },
        });
        ...
        await this.prisma.bid_Foreign.create({ data });
      }
  ...
  async getKeywords(
    data: Bid_Construction | Bid_Foreign | Bid_Service | Bid_Thing,
  ) {
    let content: string;
