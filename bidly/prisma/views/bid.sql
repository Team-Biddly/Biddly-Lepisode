...
SELECT 
    ...
    "Bid_Construction"."입찰마감일시",
    COALESCE("Bid_Construction"."예산금액",0) AS "배정예산금액",
    "Bid_Construction"."공고기관명",
    "Bid_Construction"."수요기관명",
    "Bid_Construction"."공고기관담당자명",
    COALESCE("Bid_Construction"."공고기관담당자전화번호", '') AS "공고기관담당자전화번호",
    COALESCE("Bid_Construction"."공고기관담당자이메일주소", '') AS "공고기관담당자이메일주소",
...
SELECT 
    ...
    COALESCE("Bid_Foreign"."공고기관담당자전화번호", '') AS "공고기관담당자전화번호",
    COALESCE("Bid_Foreign"."공고기관담당자이메일주소", '') AS "공고기관담당자이메일주소",
    "Bid_Foreign"."입찰방식명",
    "Bid_Foreign"."공고종류명",
...
SELECT 
    ...
    COALESCE("Bid_Service"."공고기관담당자전화번호", '') AS "공고기관담당자전화번호",
    COALESCE("Bid_Service"."공고기관담당자이메일주소", '') AS "공고기관담당자이메일주소",
    "Bid_Service"."입찰방식명",
    "Bid_Service"."공고종류명",
...
SELECT 
    ...
    "Bid_Thing"."수요기관명",
    "Bid_Thing"."공고기관담당자명",
    COALESCE("Bid_Thing"."공고기관담당자전화번호", '') AS "공고기관담당자전화번호",
    COALESCE("Bid_Thing"."공고기관담당자이메일주소", '') AS "공고기관담당자이메일주소",
    "Bid_Thing"."입찰방식명",
    "Bid_Thing"."공고종류명",
...
SELECT 
    ...
    "Bid_Etc"."입찰개시일시",
    "Bid_Etc"."입찰마감일시",
    COALESCE("Bid_Etc"."추정가격", 0),
    "Bid_Etc"."공고기관명",
    "Bid_Etc"."수요기관명",
    ''::text AS "공고기관담당자명",
    ''::text AS "공고기관담당자전화번호",
    ''::text AS "공고기관담당자이메일주소",
    "Bid_Etc"."입찰방식명",
    "Bid_Etc"."공고종류명",
    starts_with("Bid_Etc".id, 'T') AS "모의공고여부",
    "Bid_Etc"."등록일시",
    "Bid_Etc"."공고규격서URL",
    "Bid_Etc".keywords
FROM "Bid_Etc"